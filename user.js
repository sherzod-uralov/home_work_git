...
const user = users.map((user) => {
    return `
    <div class="card">
    <img class="radius" src="${user.avatar_url}" alt="">
    <div class="card__user">
        <img src="./user-02-svgrepo-com.svg" alt="">
        <h3>${user.login}</h3>
        </div>
        <a class="accaunts" href="${user.html_url}">accaunts</a>
</div>
`
})
cards.innerHTML = user.join('');
...
toggle.addEventListener('change', () => {
    ...
    nav.classList.toggle('night_nav');
});